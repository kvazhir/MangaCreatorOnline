...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2015 at 09:37 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6538 ;
...
CREATE TABLE IF NOT EXISTS `user_profile_style` (
  `user` varchar(16) NOT NULL,
  `description` varchar(256) DEFAULT NULL,
  `background` varchar(128) NOT NULL DEFAULT '#ffffff',
  `background_size` varchar(16) NOT NULL DEFAULT 'auto',
  ...
  `title_outline` varchar(128) NOT NULL DEFAULT 'none',
  ...
  `description_outline` varchar(128) NOT NULL DEFAULT 'none',
  ...
  `stats_outline` varchar(128) NOT NULL DEFAULT 'none',
...
--
ALTER TABLE `forum_post`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=6538;
--
